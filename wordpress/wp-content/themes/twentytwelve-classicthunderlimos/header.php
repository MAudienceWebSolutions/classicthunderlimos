...
<body <?php body_class(); ?>>
	...
	<div id="page" class="hfeed site">
		...
		<header id="masthead" class="site-header" role="banner">
			...
			<div id="post-banner-info" class="post-banner-info">
		...
		<?php if (is_front_page()) : ?>
			<div id="front-page-slide-wrap" class="front-page-slide-wrap">
				<?php if ( function_exists( 'soliloquy' ) ) { soliloquy( '195' ); } ?>
				<?php if ( function_exists( 'soliloquy' ) ) { soliloquy( 'home-slider-full-width', 'slug' ); } ?>
			</div>
		<?php endif; ?>
